...
def payment_completed(request):
    ...
    elif order.shipping == "S":
        print("Osobni doruceni. - tohle testuji ted")
...
def manual_payment_completed(request, order_id,vendor_type):
    ...
    if vendor_type == "Z":
        zasilkovna_create_package(order_id)
        print("Manual payment. Zasilkovna package has been created")
    elif vendor_type == ("P" or "D"):
        ppl_create_label_view(request, order_id)
        print("Manual payment. PPL package has been created")
    elif vendor_type == "O":
        print("Manual payment. Online delivery has been requested")
    elif vendor_type == "S":
